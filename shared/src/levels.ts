...
export const LEVELS: LevelDef[] = [
  ...
  { level: SkillLevel.L2, weight: 2, title: '入门', desc: '能连续对拉多拍，规则熟悉', default: true },
  { level: SkillLevel.L3, weight: 3, title: '初阶', desc: '会高远球/吊球，有基本步法' },
...
export const DEFAULT_LEVEL = SkillLevel.L2;
